...
// CHANGE PASSWORD
// FIX: was bcrypt.compare(currentPassword, newPassword) — must compare against DB hashed password
export async function updatePassword(req, res) {
    ...
    try {
        ...
        // FIX: compare currentPassword against the stored hashed password
